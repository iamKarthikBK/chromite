...
1. ISA: RV32*FD* - currently only RV32IMAFC is superset which can be supported in rv32. This is on the list of critical tasks and will be resolved soon.
2. Caches cannot be disabled with supervisor on. This will be fixed soon as well.
