...
//
// On Sat Oct  2 15:35:20 +0530 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkicache_tag(CLK,
  ...
  // value method mv_read_response
  assign mv_read_response = { x__h3113, x__h3920 } ;
  ...
  begin
    ...
    if (EN_ma_request)
      begin
        TASK_testplusargs___d16 = $test$plusargs("micache");
	#0;
      end
    if (EN_ma_request)
      begin
	...
	(TASK_testplusargs___d15 ||
	 TASK_testplusargs___d16 && TASK_testplusargs___d17))
      $write("[%2d]ICACHE: TagReq: Tag:%h RW:%b Way:%d index:%d",
	     id,
