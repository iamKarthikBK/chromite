...
// fn_decode_fn_csrs              I   143 unused
//
// Combinational paths from inputs to outputs:
//   fn_decode_fn_inst -> fn_decode_fn
//
//
...
module module_fn_decode_fn(fn_decode_fn_inst,
  ...
  reg [3 : 0] CASE_fn_decode_fn_inst_BITS_14_TO_12_0b0_IF_fn_ETC__q2,
	      CASE_fn_decode_fn_inst_BITS_14_TO_12_0b10_0b11_ETC__q1;
  wire [3 : 0] IF_fn_decode_fn_inst_BIT_30_9_THEN_0b1011_ELSE_ETC___d30;
		 ...
		 fn_decode_fn_inst[27] } :
		  ...
		  ((fn_decode_fn_inst[6:4] == 3'b001 &&
		    fn_decode_fn_inst[2:0] == 3'b011) ?
		     CASE_fn_decode_fn_inst_BITS_14_TO_12_0b10_0b11_ETC__q1 :
		     ((!fn_decode_fn_inst[31] &&
		       fn_decode_fn_inst[29:25] == 5'b0 &&
		       fn_decode_fn_inst[6:4] == 3'b011 &&
		       fn_decode_fn_inst[2:0] == 3'b011) ?
			CASE_fn_decode_fn_inst_BITS_14_TO_12_0b0_IF_fn_ETC__q2 :
			4'd0))) ;
  ...
  begin
    case (fn_decode_fn_inst[14:12])
      3'b010:
	  CASE_fn_decode_fn_inst_BITS_14_TO_12_0b10_0b11_ETC__q1 = 4'b1100;
      3'b011:
	  CASE_fn_decode_fn_inst_BITS_14_TO_12_0b10_0b11_ETC__q1 = 4'b1110;
      3'b101:
	  CASE_fn_decode_fn_inst_BITS_14_TO_12_0b10_0b11_ETC__q1 =
	      IF_fn_decode_fn_inst_BIT_30_9_THEN_0b1011_ELSE_ETC___d30;
      default: CASE_fn_decode_fn_inst_BITS_14_TO_12_0b10_0b11_ETC__q1 =
  ...
  begin
    case (fn_decode_fn_inst[14:12])
      ...
      3'b010:
	  CASE_fn_decode_fn_inst_BITS_14_TO_12_0b0_IF_fn_ETC__q2 = 4'b1100;
      3'b011:
	  CASE_fn_decode_fn_inst_BITS_14_TO_12_0b0_IF_fn_ETC__q2 = 4'b1110;
      3'b101:
	  CASE_fn_decode_fn_inst_BITS_14_TO_12_0b0_IF_fn_ETC__q2 =
	      IF_fn_decode_fn_inst_BIT_30_9_THEN_0b1011_ELSE_ETC___d30;
      default: CASE_fn_decode_fn_inst_BITS_14_TO_12_0b0_IF_fn_ETC__q2 =
		   { 1'b0, fn_decode_fn_inst[14:12] };
    endcase
  end
