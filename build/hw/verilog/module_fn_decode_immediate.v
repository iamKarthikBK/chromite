...
//
// On Sat Oct  2 15:35:18 +0530 2021
//
//
// Ports:
// Name                         I/O  size props
...
// fn_decode_immediate_csrs       I   143
//
...
module module_fn_decode_immediate(fn_decode_immediate_inst,
  ...
  input  [142 : 0] fn_decode_immediate_csrs;
  ...
  wire [10 : 0] bit20_30__h34;
  wire [7 : 0] bit12_19__h33;
  wire bit31__h35;
  ...
  assign IF_fn_decode_immediate_inst_BITS_6_TO_2_EQ_0b1_ETC___d57 =
		 ...
		 fn_decode_immediate_csrs[69]) ?
		  ...
		  fn_decode_immediate_inst[6:2] != 5'b11011 &&
		  fn_decode_immediate_inst[20]) } ;
  assign bit12_19__h33 = {8{fn_decode_immediate_inst[31]}} ;
  assign bit20_30__h34 =
	     { bit12_19__h33,
	       fn_decode_immediate_inst[31],
	       fn_decode_immediate_inst[31],
	       fn_decode_immediate_inst[31] } ;
  assign bit31__h35 =
	     fn_decode_immediate_inst[6:2] != 5'b01011 &&
	     fn_decode_immediate_inst[31] ;
  always@(fn_decode_immediate_inst or bit12_19__h33)
  begin
  ...
  always@(fn_decode_immediate_inst or bit20_30__h34)
  begin
    case (fn_decode_immediate_inst[6:2])
      5'b00101, 5'b01101:
	  CASE_fn_decode_immediate_inst_BITS_6_TO_2_0b10_ETC__q4 =
