...
//
// On Sat Oct  2 15:35:57 +0530 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkdmem(pmp_cfg_0,
  ...
  input  [142 : 0] receive_core_req_put;
  ...
  input  [63 : 0] put_resp_from_ptw_put;
  ...
  wire [76 : 0] dcache_send_core_io_resp;
  wire [75 : 0] dcache_get_ptw_resp_get, dcache_send_core_cache_resp_get;
  wire [65 : 0] dcache_receive_mem_rd_resp_put;
  wire [64 : 0] dcache_receive_mem_io_resp_put;
  wire [42 : 0] dcache_send_mem_rd_req_get;
  wire [40 : 0] dcache_put_pa_from_tlb_put;
  wire [1 : 0] dcache_ma_commit_store_c, dcache_ma_curr_priv_c;
  ...
  wire [75 : 0] dtlb_put_core_request_put;
  wire [65 : 0] dtlb_get_request_to_ptw_get;
  wire [63 : 0] dtlb_ma_mstatus_from_csr_m,
		dtlb_ma_satp_from_csr_s,
		dtlb_put_response_frm_ptw_put;
  wire [40 : 0] dtlb_get_core_response_get;
  ...
  mkdcache #(.id(id)) dcache(.pmp_cfg_0(pmp_cfg_0),
			     ...
			     .ma_commit_store_c(dcache_ma_commit_store_c),
  ...
  assign dcache_ma_commit_store_c = ma_commit_store_storecommit ;
  ...
  assign dcache_receive_core_req_put =
	     { receive_core_req_put[142:79],
	       receive_core_req_put[74],
	       receive_core_req_put[78],
	       receive_core_req_put[73:72],
	       receive_core_req_put[77:75],
	       receive_core_req_put[71:3],
  ...
  assign dtlb_EN_put_core_request_put =
	     EN_receive_core_req_put && !receive_core_req_put[74] ;
