...
//
// On Sat Oct  2 15:35:59 +0530 2021
//
//
// Ports:
// Name                         I/O  size props
...
// s3_cache_mv_memory_request_get  O   143
...
// s4_cache_memory_response_put   I    76
...
// s5_cache_ma_io_response_r      I    77
...
//    EN_interrupts_ma_plic_seip) -> sbread_mv_csr_mip
//   (interrupts_ma_plic_seip_intrpt,
...
module mkriscv(resetpc,
  ...
  output [142 : 0] s3_cache_mv_memory_request_get;
  ...
  input  [75 : 0] s4_cache_memory_response_put;
  ...
  input  [76 : 0] s5_cache_ma_io_response_r;
  ...
  wire [142 : 0] s3_cache_mv_memory_request_get;
  ...
  wire [63 : 0] csrs_mv_csr_mstatus,
		...
		sbread_mv_csr_stvec,
		sbread_mv_csr_time;
  wire [31 : 0] csrs_mv_pmp_cfg, sbread_mv_csr_mcountinhibit;
  wire [4 : 0] pipe_status_mv_pipe_isbs_empty;
  ...
  // inlined wires
  wire [74 : 0] wr_bypass_wget, wr_bypass_1_wget;
  ...
  wire [73 : 0] ff_baseout_D_IN, ff_baseout_D_OUT;
  wire ff_baseout_CLR,
       ff_baseout_DEQ,
       ff_baseout_EMPTY_N,
       ff_baseout_ENQ,
  ...
  wire [73 : 0] ff_baseout_1_D_IN, ff_baseout_1_D_OUT;
  ...
  // ports of submodule ff_mbox_out_firstValid
  wire ff_mbox_out_firstValid_D_IN,
       ff_mbox_out_firstValid_EN,
       ff_mbox_out_firstValid_Q_OUT;

  // ports of submodule ff_memoryout
  wire [7 : 0] ff_memoryout_D_IN, ff_memoryout_D_OUT;
  ...
  wire [68 : 0] ff_wbmemop_D_IN, ff_wbmemop_D_OUT;
  wire ff_wbmemop_CLR,
       ff_wbmemop_DEQ,
       ff_wbmemop_EMPTY_N,
       ff_wbmemop_ENQ,
  ...
  wire [95 : 0] pipe_s2s3_notEmpty_ff_meta_D_IN,
  ...
  wire [12 : 0] pipe_s2s3_notEmpty_ff_opmeta_D_IN,
  ...
  wire [142 : 0] stage2_common_ma_csrs_csr;
  wire [119 : 0] stage2_rx_rx_from_stage1_first_x;
  wire [95 : 0] stage2_tx_tx_meta_to_stage3_enq_data;
  wire [74 : 0] stage2_rf_mv_op1, stage2_rf_mv_op2, stage2_rf_mv_op3;
  wire [73 : 0] stage2_common_ma_commit_rd_commit;
  wire [63 : 0] stage2_tx_tx_mtval_to_stage3_enq_data;
  wire [12 : 0] stage2_tx_tx_opmeta_to_stage3_enq_data;
  ...
  wire [149 : 0] stage3_bypass_ma_bypass_fwd;
  wire [142 : 0] stage3_cache_mv_memory_request_get;
  wire [141 : 0] stage3_bpu_mv_train_bpu;
  wire [131 : 0] stage3_muldiv_mv_mbox_inputs;
  wire [95 : 0] stage3_rx_rx_meta_from_stage2_first_x;
  wire [80 : 0] stage3_tx_tx_systemout_to_stage4_enq_data;
  wire [76 : 0] stage3_tx_tx_fuid_to_stage4_enq_data;
  wire [74 : 0] stage3_rf_ma_op1_i, stage3_rf_ma_op2_i, stage3_rf_ma_op3_i;
  wire [73 : 0] stage3_common_ma_sb_release_commit,
		stage3_tx_tx_baseout_to_stage4_enq_data;
  ...
  wire [12 : 0] stage3_rx_rx_opmeta_from_stage2_first_x;
  wire [7 : 0] stage3_bpu_mv_mispredict_snd,
	       stage3_tx_tx_memoryout_to_stage4_enq_data;
  wire [3 : 0] stage3_rx_rx_instrtype_from_stage2_first_x;
  wire [1 : 0] stage3_muldiv_ma_mbox_ready_rdy;
  ...
  wire [76 : 0] stage4_rx_rx_fuid_from_stage3_first_x;
  wire [75 : 0] stage4_cache_memory_response_put,
		stage4_tx_tx_fuid_to_stage5_enq_data;
  wire [73 : 0] stage4_rx_rx_baseout_from_stage3_first_x,
  ...
  wire [68 : 0] stage4_tx_tx_memio_to_stage5_enq_data;
  wire [63 : 0] stage4_s4_mbox_rx_mbox_output_first_x;
  wire [7 : 0] stage4_rx_rx_memoryout_from_stage3_first_x;
  ...
  wire [142 : 0] stage5_csrs_mv_csrs_to_decode;
  wire [127 : 0] stage5_csrs_mv_pmp_addr;
  wire [80 : 0] stage5_rx_rx_systemout_from_stage4_first_x;
  wire [76 : 0] stage5_cache_ma_io_response_r;
  wire [75 : 0] stage5_rx_rx_fuid_from_stage4_first_x;
  wire [73 : 0] stage5_common_mv_commit_rd,
		stage5_rx_rx_baseout_from_stage4_first_x;
  wire [71 : 0] stage5_rx_rx_trapout_from_stage4_first_x;
  wire [68 : 0] stage5_rx_rx_memio_from_stage4_first_x;
  ...
  wire [63 : 0] stage5_csrs_mv_csr_mstatus,
		...
		stage5_csrs_sbread_mv_csr_pmpaddr0,
  ...
  wire [2 : 0] stage5_csrs_mv_cacheenable;
  ...
  reg [63 : 0] v__h16992;
  reg rg_reset_cycle_15_EQ_512_16_AND_TASK_testplusa_ETC___d325;
  // synopsys translate_on

  // remaining internal signals
  wire [63 : 0] fl_pc__h16778;
  ...
  // value method csrs_mv_cacheenable
  assign csrs_mv_cacheenable = stage5_csrs_mv_cacheenable ;
  ...
  // submodule ff_mbox_out_firstValid
  RevertReg #(.width(32'd1), .init(1'd1)) ff_mbox_out_firstValid(.CLK(CLK),
								 .D_IN(ff_mbox_out_firstValid_D_IN),
								 .EN(ff_mbox_out_firstValid_EN),
								 .Q_OUT(ff_mbox_out_firstValid_Q_OUT));
  ...
  FIFOL1 #(.width(32'd96)) pipe_s2s3_notEmpty_ff_meta(.RST(RST_N),
						      .CLK(CLK),
  ...
  FIFOL1 #(.width(32'd13)) pipe_s2s3_notEmpty_ff_opmeta(.RST(RST_N),
							.CLK(CLK),
  ...
  assign CAN_FIRE_RL_mkConnectionVtoAf_10 = ff_pipe1_EMPTY_N ;
  assign WILL_FIRE_RL_mkConnectionVtoAf_10 = ff_pipe1_EMPTY_N ;
  ...
  assign CAN_FIRE_RL_mkConnectionVtoAf_14 = stage3_RDY_muldiv_mv_mbox_inputs ;
  ...
  assign CAN_FIRE_RL_mkConnectionVtoAf_11 =
	     stage0_RDY_s0_bpu_ma_train_bpu && stage3_RDY_bpu_mv_train_bpu ;
  assign WILL_FIRE_RL_mkConnectionVtoAf_11 =
	     CAN_FIRE_RL_mkConnectionVtoAf_11 ;

  // rule RL_mkConnectionVtoAf_12
  assign CAN_FIRE_RL_mkConnectionVtoAf_12 =
	     stage0_RDY_s0_bpu_ma_mispredict &&
	     stage3_RDY_bpu_mv_mispredict_fst &&
	     stage3_RDY_bpu_mv_mispredict_snd ;
  assign WILL_FIRE_RL_mkConnectionVtoAf_12 =
	     CAN_FIRE_RL_mkConnectionVtoAf_12 ;
  ...
  assign wr_bypass_wget =
	     { ff_baseout_D_OUT[73:70],
	       ff_baseout_EMPTY_N && ff_baseout_D_OUT[5:1] != 5'd0,
	       ff_baseout_D_OUT[5:1],
	       ff_baseout_D_OUT[69:6],
	       ff_baseout_D_OUT[0] } ;
  assign wr_bypass_1_wget =
	     { ff_baseout_1_D_OUT[73:70],
	       ff_baseout_1_EMPTY_N && ff_baseout_1_D_OUT[5:1] != 5'd0,
  ...
  // submodule ff_mbox_out_firstValid
  assign ff_mbox_out_firstValid_D_IN = 1'd1 ;
  assign ff_mbox_out_firstValid_EN = CAN_FIRE_RL_connect_ena_13 ;
  ...
  assign mbox_tx_output_enq_rdy_b = ff_mbox_out_ff_FULL_N ;
  assign mbox_tx_output_notFull_b = ff_mbox_out_ff_FULL_N ;
  ...
  assign stage0_EN_s0_bpu_ma_train_bpu = CAN_FIRE_RL_mkConnectionVtoAf_11 ;
  assign stage0_EN_s0_bpu_ma_mispredict = CAN_FIRE_RL_mkConnectionVtoAf_12 ;
  ...
  assign stage3_bypass_ma_bypass_fwd =
	     { wr_bypass_wget[74:71],
	       ff_baseout_EMPTY_N && wr_bypass_wget[70],
	       wr_bypass_wget[69:0],
	       wr_bypass_1_wget[74:71],
  ...
  assign stage4_s4_mbox_rx_mbox_output_notEmpty_b = ff_mbox_out_ff_EMPTY_N ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (rg_reset_cycle == 10'd512)
	begin
	  TASK_testplusargs___d321 = $test$plusargs("mriscv");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (rg_reset_cycle == 10'd512)
    ...
    rg_reset_cycle_15_EQ_512_16_AND_TASK_testplusa_ETC___d325 =
	rg_reset_cycle == 10'd512 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (rg_reset_cycle_15_EQ_512_16_AND_TASK_testplusa_ETC___d325)
	$write("[%10d", v__h16992, "] ");
    if (RST_N != `BSV_RESET_VALUE)
      if (rg_reset_cycle_15_EQ_512_16_AND_TASK_testplusa_ETC___d325)
	$write("[%2d]RISCV: Hart is out of reset sequence", hartid);
    if (RST_N != `BSV_RESET_VALUE)
      if (rg_reset_cycle_15_EQ_512_16_AND_TASK_testplusa_ETC___d325)
	$write("\n");
  end
